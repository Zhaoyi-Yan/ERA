...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, T,
        ...
        self.up_fc = nn.Identity() if in_c_tec == -1 else nn.Linear(self.last_channel, in_c_tec)
...
def mobilenetv2_T_w(T, W, feature_dim=100, in_c_tec=-1):
    model = MobileNetV2(T=T, feature_dim=feature_dim, width_mult=W, in_c_tec=in_c_tec)
    return model


def mobile_half(num_classes, in_c_tec=-1):
    return mobilenetv2_T_w(6, 0.5, num_classes, in_c_tec=in_c_tec)
