...
"""
for imagenet, train.txt and val.txt should look like this:
train.txt:
...
#             os.path.join(args.data_path, 'train'), os.path.join('/code/GodY_distill/gap_model/classification_residualD_vq', 'meta_yan_distill/train.txt'), transform=train_transforms_l)
        train_dataset = ImageNetDataset(
            os.path.join(args.data_path, 'train'), os.path.join(args.data_path, 'meta_yan_distill/train.txt'), transform=train_transforms_l)
    elif args.dataset == 'cifar10':
    ...
    if args.dataset == 'imagenet':
        ...
        # in common pool
#         val_dataset = ImageNetDataset(os.path.join(args.data_path, 'val'), os.path.join('/code/GodY_distill/gap_model/classification_residualD_vq', 'meta_yan_distill/val.txt'), transform=val_transforms_l)
        val_dataset = ImageNetDataset(os.path.join(args.data_path, 'val'), os.path.join(args.data_path, 'meta_yan_distill/val.txt'), transform=val_transforms_l)
    elif args.dataset == 'cifar10':
